...
CREATE TABLE episodes_hist (
	...
	CONSTRAINT episodes_hist_device_id_fkey FOREIGN KEY (device_id) REFERENCES public.devices(id) ON DELETE SET NULL ON UPDATE CASCADE,
	CONSTRAINT episodes_hist_episode_id_fkey FOREIGN KEY (episode_id) REFERENCES public.episodes(id) ON DELETE CASCADE ON UPDATE CASCADE
);
